...
class AvatarImage extends StatelessWidget {
  ...
  const AvatarImage(this.name, {this.width = 100, this.height = 150, this.bgColor, this.borderWidth = 0, this.borderColor, this.trBackground = false, this.isSVG = true, this.radius = 20});
  final String name;
  final double width;
  final double height;
